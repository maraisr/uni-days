export const API_HOST = 'http://131.181.190.87:3000';

export const APP_TITLE = 'World Happiness Report | CAB230';
...
export const YEARS = new Array(6).fill(1).map((_, i) => (2020 - i).toString());
